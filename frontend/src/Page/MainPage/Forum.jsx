    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-28 lg:py-0 max-w-6xl">
        <div className="text-center mb-6">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">Board</h2>
        </div>
                ...
                <div className="p-6 flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      {post.fileUrl.length > 0 && <span className="text-gray-500 text-sm">files: {post.fileUrl.length}</span>}
                    </div>
